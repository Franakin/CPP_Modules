...
/*   Updated: 2023/04/06 17:16:05 by fpurdom       ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << "Copy constructor called for a new " << copy.name << std::endl;
	this->name = copy.name;
...
{
	std::cout << "Copy assignment operator called for a new " << copy.name << std::endl;
	this->name = copy.name;
	this->hitPoints = copy.hitPoints;
	this->energyPoints = copy.energyPoints;
	this->attackDamage = copy.attackDamage;
