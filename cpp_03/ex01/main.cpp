...
/*   Updated: 2023/04/06 19:29:57 by fpurdom       ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
	ScavTrap	bob1("Bob"), dylan("Dylan"), mrpoopiebutthole("Mr Poopie Butthole");
	ScavTrap	empty;
	ScavTrap	bob2(bob1);
	ScavTrap	bob3("you sure this is bob?");
